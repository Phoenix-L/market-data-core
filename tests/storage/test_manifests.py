...
def test_manifest_contains_contract_keys() -> None:
    metadata = DatasetMetadata(
        dataset_id="cn_equity_30m_raw",
        market="cn_equity",
        frequency="30m",
        adjustment_mode="raw",
        provider="stub",
    )
    payload = build_manifest(metadata, row_count=5, symbol_count=1, min_timestamp="2026-01-01", max_timestamp="2026-01-02")
